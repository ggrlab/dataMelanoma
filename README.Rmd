...
## Installation
You need to have git-lfs installed after all data/*.rda are stored within github as 
git-lfs. See https://git-lfs.com/ how to install. To check if git-lfs is installed: 

```bash 
git lfs version
```
Should result in something like ``git-lfs/2.9.2 (GitHub; linux amd64; go 1.13.5)``
...
# Thoughts
 ...
 - I recently found ExperimentHub, maybe that might be of use https://bioconductor.org/packages/3.16/bioc/html/ExperimentHub.html
